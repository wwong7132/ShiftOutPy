...
if __name__ == "__main__":
    ...
    while True:
        ...
        monitor._ShiftOut(0x01)  #00001
        print(b'0x01')
        sleep(1)

        monitor._ShiftOut(0x03)  #0011
        print(b'0x03')
        sleep(1)

        monitor._ShiftOut(0x05)  #0101
        print(b'0x05')
        sleep(1)

        monitor._ShiftOut(0x09)  #1001
        print(b'0x09')
        sleep(1)
